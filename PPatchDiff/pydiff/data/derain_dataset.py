...
class DERAIN_Dataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        gt_name = gt_name.replace('norain', 'rain')
        ...
        gt_img = self.rot_check(gt_img) 
        input_img = self.rot_check(input_img)
...
if __name__ == '__main__':
    ...
    dataset = DERAIN_Dataset(opt['datasets']['train'])
