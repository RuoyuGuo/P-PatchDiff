...
class PALayer(nn.Module):
    def __init__(self, att_dim, x_dim):
        ...
        self.conv_gamma_en = nn.Conv2d(att_dim, x_dim//2, 1)
    ...
    def forward(self, x, p_feats):    
        ...
        gamma = self.conv_gamma_de(self.conv_gamma_mid(self.conv_gamma_en(p_feats)))
        beta = self.conv_beta_de(self.conv_beta_mid(self.conv_beta_en(p_feats)))
        out = x * gamma  + beta
